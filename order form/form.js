...
function UpdateCart(product) {
    ...
    if (getCartNumber) {
        ...
        document.getElementById("item").innerHTML = getCartNumber + 1 + " items";
    }
    else {
...
function showCartNumber() {
    ...
    if (getCartNumber) {
        ...
        document.getElementById("item").innerHTML = getCartNumber + " items";
    }
    else {
        document.getElementById("items").innerHTML = 0;
        document.getElementById("item").innerHTML = 0 + " item";
    }
}
showCartNumber();
